...
const numberList1 = [
    18, 3, 6, 8, 19, 4, 3, 13, 13, 8,
     13, 14, 2, 19, 16, 4, 15, 9, 4, 12, 6, 9, 0,
  ...
  const numberList2 = [
    13, 20, 13, 7, 11, 5, 6, 2, 8, 10, 11,
     8, 5, 17, 6, 12, 16, 2, 14, 10, 16, 16,
  ...
  const commonNumberinBothList = numberList1.filter((data) => numberList2.includes(data));
